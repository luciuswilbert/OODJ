...
public class AddSalesPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        comboBoxItemId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboBoxItemIdActionPerformed(evt);
            }
        });
    ...
    private void updateSaleId() {
        ...
        txtSaleId.setText(sale.nextRecordId());
    }
    ...
    private void btnAddNewSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNewSaleActionPerformed
        ...
        if (sale.checkDuplicateSaleEntry(itemId, saleDateString)) {
            ...
            // check sufficient stock level
            if (!sale.sufficientStockLevel(itemId, quantitySold)) {
                JOptionPane.showMessageDialog(null, "The quantity sold is above the current stock level", "Insufficient Stock Level", JOptionPane.INFORMATION_MESSAGE);
                   return;
            }
            
            String newRow[] = {salesId, itemId, itemName, saleDateString, Integer.toString((int) quantitySold)};  
    ...
    private void btnSaveNewSalesToFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveNewSalesToFileActionPerformed
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            Sale new_sl = new Sale(saleId, itemId, quantitySold, saleDate, userId, true);
            
            try {
                // Deduct item stock using quantity sold
                sale.deductStockLevel(itemId, quantitySold);
    ...
    private void btnEditNewSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditNewSaleActionPerformed
        if(row==-1){
            ...
            String editedRow[] = {saleId, itemId, itemName, saleDateString, Integer.toString((int) quantitySold)};  
    ...
    private void comboBoxItemIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBoxItemIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comboBoxItemIdActionPerformed
