...
public class CreatePurchaseRequisitionPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("IMPORTANT: Only items that have a stock level BELOW their respective reorder level will appear as an option in the Item Name list");
    ...
    private void updatePurchaseRequisitionId() {
        ...
        txtPurchaseRequisitionId.setText(salesManager.nextRecordId("purchase_requisition.txt"));
    }
    ...
    private void updateItemNameComboBox() {
        ...
        Map<String,List<?>> map = salesManager.updateItemSelectionList(itemNames, itemIds, stockLevels, reorderLevels);
        ...
        for (int i = 0; i < count; i++) {
            if (stockLevels.get(i) < reorderLevels.get(i)) {
                comboBoxItemName.addItem(itemNames.get(i));
            }
        }
    ...
    private void btnSaveNewPurchaseRequisitionToFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveNewPurchaseRequisitionToFileActionPerformed
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            // Append to file
            if (purchaseRequisition.writePurchaseRequisitionData(requisitionId, userId, itemId, quantityRequested)) {
