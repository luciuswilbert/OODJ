...
import asm.User;
import asm.utilities.Email;
import asm.utilities.BDUtility;
import asm.utilities.Email;
...
public class Profile_form extends javax.swing.JPanel {
    ...
    private final String file = "src/User/User.txt";
    private User owner;
    private File img, selectedFile = null;
    
    public Profile_form(User user){
        this.owner = user;
        initComponents();
        initialize(owner);
        try {
    ...
    public final void populateForm(User user) throws FileNotFoundException{
        BDUtility.setImage(profile_lb, BDUtility.getPath(user.getUsername()), 190, 190);
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(174, 174, 174)
                .addComponent(profile_lb, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                .addGap(32, 32, 32)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(40, 40, 40))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(profile_lb, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(95, 95, 95)))
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_btnActionPerformed
        ...
        try {
            ...
            // Loop through each user entry to check for match
            for(Map<String, String> user : users){
                String username = user.get("username");
                
                // Check if entered credentials match current user entry
                if (username.equals(owner.getUsername())){
                    user.put("full_name", fullname_lb.getText().trim());
                    user.put("password", password_lb.getText().trim());
                    user.put("email", email_lb.getText().trim());
                    user.put("contact_number", contactnum_lb.getText().trim());
                    
                    if (img != null){
                        user.put("image_path", img.getPath());
                    }
    ...
    private void cancel_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancel_btnActionPerformed
        ...
        owner.setImage_path(selectedFile.getPath());
        }
        initialize(owner);
    ...
    private void password_lbFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_password_lbFocusLost
        ...
        else if (!txt.isValidPassword(password_lb.getText())) {
    ...
    private void email_lbFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_email_lbFocusLost
        ...
        else if (!Email.isValidEmailAddress(email_lb.getText())){
    ...
    private void profile_lbMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_profile_lbMouseReleased
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            String fileExtension = BDUtility.getFileExtension(selectedFile.getName());
            ...
            img = new File(destinationDirectory, username_lb.getText() + "." + fileExtension);
            try {
    ...
    private void initialize(User user){
        ...
        email_lb.setText(owner.getEmail());
        contactnum_lb.setText(owner.getContact_number());
        role_lb.setText(User.getRole(owner.getRole()));   
    }
