...
public class SalesRecordsPanel extends javax.swing.JPanel {
    ...
    private void jTable2MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseReleased
        ...
        comboBoxItemName.setSelectedItem(itemNames.get(itemIds.indexOf(itemId)));
    ...
    private void btnEditNewSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditNewSaleActionPerformed
        if(row==-1){
            ...
            if (response == JOptionPane.YES_OPTION) {
                ...
                String modifierId = txtModifierId.getText();
                ...
                // update table
                String editedRow[] = {saleId, itemId, saleDateString, quantitySold, creationDateString, creatorId, modifiedDateString, modifierId, modifyReason};
    ...
    private void overwriteFile() {
        // Create a list to hold the contents of the table
        List<Map<String, Object>> contents = new ArrayList<>();

        // rewrite to file
        int rowCount = jTable2.getRowCount();
        for (int i = 0; i < rowCount; i++) {
            // Create a map to represent a single row
            Map<String, Object> rowData = new LinkedHashMap<>();

            // Extract the data from each column
            rowData.put("saleId", jTable2.getValueAt(i, 0));
            rowData.put("itemId", jTable2.getValueAt(i, 1));
            rowData.put("saleDate", jTable2.getValueAt(i, 2));
            rowData.put("quantitySold", jTable2.getValueAt(i, 3));
            rowData.put("creationDate", jTable2.getValueAt(i, 4));
            rowData.put("creatorId", jTable2.getValueAt(i, 5));
            rowData.put("modifiedDate", jTable2.getValueAt(i, 6));
            rowData.put("modifierId", jTable2.getValueAt(i, 7));
            rowData.put("modifyReason", jTable2.getValueAt(i, 8));

            // Add the row map to the contents list
            contents.add(rowData);
        } 
        
        // Write the updated contents to the file        
        if (salesManager.overwriteSalesRecords(contents)) {
